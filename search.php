<?php
/**
 * The template for displaying Search Results searchs.
 *
 * @package naked
 */
...
<div class="main-content">	
	<div class="container <?php echo $content_layout_class; ?>">
		<div class="row">
			...
			<?php if ( $GLOBALS['main_content_width'] !=0 ): /*checks for zero width middle column, zero width isn't displayed*/?>
			
			<div class="main-content-inner col-12 col-lg-<?php echo  $main_content_shift_string;/*sets the middle column twitter width units*/ ?>">
				<div id="primary" class="content-area">
					...
					<header class="search-header">
						<h2 class="search-title"><?php printf( __( 'Search Results for: %s', 'naked' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
