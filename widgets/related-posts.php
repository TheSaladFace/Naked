...
class thshpr_related_posts_widget extends WP_Widget {
	...
	function thshpr_related_posts_Widget() {
		$widget_ops = array('classname' => 'widget_related_posts', 'description' => __( "Displays related posts by tags", 'thshpr') );
		$this->__construct('related_posts', __('Naked Related Posts', 'thshpr'), $widget_ops);
