<?php
/**
* Description: Related Posts Widget
* Author: Naked Themes
...
add_action( 'widgets_init', 'naked_related_posts_widget' );

/**
* Register the widget
* @since 0.1
*/
function naked_related_posts_widget() {
	register_widget( 'naked_related_posts_Widget' );
}

class naked_related_posts_widget extends WP_Widget {

	function naked_related_posts_Widget() {
		$widget_ops = array('classname' => 'widget_related_posts', 'description' => __( "Displays posts from a selected category", 'naked') );
		$this->WP_Widget('related_posts', __('(Theme) Related Posts', 'naked'), $widget_ops);
