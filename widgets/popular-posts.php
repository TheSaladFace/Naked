...
class naked_popular_posts_widget extends WP_Widget {
	...
	function naked_popular_posts_Widget() {
		...
		parent::__construct('popular_posts', __('Naked Popular Posts', 'naked'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$query = array(
			...
			'meta_key'     => 'thshpr_popular_posts_count',
		);
		/**
		 * Get category ID's
		 */
		...
		echo'<div class="popular-posts-wrap posts posts-widget">';
