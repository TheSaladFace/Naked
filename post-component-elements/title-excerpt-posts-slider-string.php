...
{
    $item_string.='<div class="component-element meta-title"><h5><a href="'.get_permalink().'">'.get_the_title().'</a></h5></div><div class="meta-excerpt component-element"><a href="'.get_permalink().'" >'.thshpr_stripped_excerpt($excerpt_length).'</a></div><div class="hidden-thumb">'.$hidden_thumb.'</div><span class="hidden-desc">'.get_the_title().'</span>';
}
?>
