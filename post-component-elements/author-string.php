...
$author_link_string='<div class="author-link small-italic '.$author_image_visible_class.'"><a href="'.get_author_posts_url( get_the_author_meta( 'ID' ) ).'">'.__( 'By ', 'thshpr' ).get_the_author().'</a></div>';
