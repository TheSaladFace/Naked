<?php
/**
 * Generates image righ 50% blog layout
...
{
	$item_string.='<div class="fw-col-md-6 '.$vertical_align_columns_string.'"><div class="components-holder focus '.$vertical_align_columns_string.'"><div class="rw-holder">';
}
