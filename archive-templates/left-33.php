<?php
/**
 * Generates image left 1/3 blog layout
...
{
 	$item_string.='</div></div></div><div class="fw-col-md-8 '.$vertical_align_columns_string.'"><div class="components-holder focus '.$vertical_align_columns_string.'"><div class="rw-holder">';
}
