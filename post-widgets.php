...
function thshpr_twitter_Widget() {
	...
	// Create the widget
	$this->__construct( 'thshpr_tweet_widget',  THEME_SLUG.' - '.__('Twitter Widget','thshpr'), $widget_ops);
...
function thshpr_flickr_Widget() {
	...
	$this->__construct( 'thshpr_flickr_widget',  THEME_SLUG.' - '.__('Flickr Widget', 'thshpr'), $widget_ops);
...
class thshpr_contact_info_widget extends WP_Widget {
	...
	function thshpr_contact_info_Widget() {
		...
		// Create the widget
		$this->__construct('thshpr_contact_info', THEME_SLUG.' - '.__('Contact Info Widget', 'theshpr'), $widget_ops);
...
class thshpr_social_media_widget extends WP_Widget {
	...
	function thshpr_social_media_Widget() {
		...
		// Create the widget
		$this->__construct('thshpr_social_media', THEME_SLUG.' - '.__('Social Media Widget', 'theshpr'), $widget_ops);
...
class thshpr_related_posts_widget extends WP_Widget {
	...
	function thshpr_related_posts_Widget() {
		...
		// Create the widget
		$this->__construct('thshpr_related_posts', THEME_SLUG.' - '.__('Related Posts', 'thshpr'), $widget_ops);
...
class thshpr_popular_posts_widget extends WP_Widget {
	...
	function thshpr_popular_posts_Widget() {
		...
		$this->__construct('popular_posts',  THEME_SLUG.' - '.__('Popular Posts', 'thshpr'), $widget_ops);
...
class thshpr_recent_posts_widget extends WP_Widget {
	...
	function thshpr_recent_posts_Widget() {
		...
		$this->__construct('recent_posts', THEME_SLUG.' - '.__('Recent Posts', 'thshpr'), $widget_ops);
...
class thshpr_mini_blog_widget extends WP_Widget {
	...
	function thshpr_mini_blog_Widget() {
		...
		$this->__construct('mini_blog',  THEME_SLUG.' - '.__('Mini_Blog', 'thshpr'), $widget_ops);
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
	...
	function widget($args, $instance) {
		...
		while ($r->have_posts())
		{
			...
			echo 	'<a class="thumb-title" href="'.get_permalink().'" title="'.get_the_title().'">'.get_the_title().'</a>';
			if($extra=='time')
			{
				echo'	<a class="date" href="'.get_permalink().'" title="'.get_the_title().'">'.get_the_date().'</a>';
			}
...
class thshpr_ad_125_widget extends WP_Widget {
	...
	function thshpr_ad_125_Widget() {
		...
		$this->__construct('thshpr_ad_125_Widget', THEME_SLUG.' - '.__('Advertisement', 'thshpr').' 125', $widget_ops);
