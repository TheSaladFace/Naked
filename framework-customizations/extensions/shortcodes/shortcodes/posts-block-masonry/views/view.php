...
wp_enqueue_script('masonry', $uri . '/static/js/masonry.pkgd.min.js',array('jquery'),'',true );
wp_enqueue_script('masonry-init', $uri . '/static/js/masonry-init.js',array('jquery','masonry'),'',true );
