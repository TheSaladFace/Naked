...
$options = array(
	...
	'opt_posts_block_number_posts'              =>array(
		...
		'desc'  => __('Enter the number of posts per page', 'unyson'),
	),
	...
	'opt_posts_block_columns'              => array(
		...
		'type'    => 'short-select',
		'value'   => '3',
		'desc'    => __( 'Please select how many columns for this posts block',
			'unyson' ),
		'choices' => array(
			'2' => '2',
			'3' => '3',
	...
	'opt_posts_block_prev_post_text'                      => array(
		'label' => __( 'Prev Post Text', 'unyson' ),
		'type'  => 'text',
		'value' => 'Prev',
	...
	'opt_large_image_ratio'              => array(
		...
		'type'    => 'short-select',
		'value'   => '3:2',
		'desc'    => __( 'Please select the ratio of the image for this posts block (if the thumbnail post element is added above)',
			'unyson' ),
		'choices' => array(
			'16:9' => '16:9',
			'3:2' => '3:2',
