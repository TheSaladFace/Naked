...
$width=714; //note, this is large even for small images because of  responsive sizes.
				...
				if ($components_elements): foreach ($components_elements as $key=>$value) 
				{
					switch($value['opt_header_featuredposts_rows']) 
					{
								...
								$item_string.='<a href="'.get_permalink().'" class="component-element image-holder">
													<div class="grid">											
														<div class="effect-1">';
															...
															$item_string.=naked_generate_image($width,$large_height,get_the_ID());
															
															if($show_hover_effects=="Yes")
															{
						...
						case 'Title': 
								...
								$item_string.='<h3 class="component-element small-headline"><a href="'.get_permalink().'">'.get_the_title().'</a></h3>';
						break;
