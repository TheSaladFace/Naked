...
/** Background settings from options **/
$bg_color = '';
...
/** Margins and padding from options **/
$padding_top ='';
...
/** Parallax background from options **/
$bg_attachment='';
...
if ( ! empty( $atts['background_parallax_ratio'] ) ) {
	...
	wp_enqueue_script('thshpr-stellar-init', $uri . '/static/js/stellar-init.js',array('jquery'),'',true );
...
/** Video background from options (unchanged from default unyson) **/
$bg_video_data_attr    = '';
...
/** Only parallax if set in options **/
if ( ! empty( $atts['background_parallax_ratio'] ) ) {
