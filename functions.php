...
function thshpr_print_styles()
{
    ...
    $top_level_menu = fw_get_db_customizer_option('opt_top_level_menu');
    $sub_level_menu = fw_get_db_customizer_option('opt_sub_level_menu');
    $mega_menu_border_color = fw_get_db_customizer_option('opt_mega_menu_border_color');



    $large_excerpt = fw_get_db_customizer_option('opt_large_excerpt');
    $large_excerpt_hover = fw_get_db_customizer_option('opt_large_excerpt_font_hover_color');
    $large_excerpt_medium_devices_desktops=fw_get_db_customizer_option('opt_large_excerpt_medium_devices_desktops');
	$large_excerpt_small_devices_tablets=fw_get_db_customizer_option('opt_small_large_excerpt_devices_tablets');
    $large_excerpt_extra_small_devices_phones=fw_get_db_customizer_option('opt_large_excerpt_extra_small_devices_phones');
    $large_excerpt_tiny_devices_phones=fw_get_db_customizer_option('opt_large_excerpt_tiny_devices_phones');

    $small_excerpt = fw_get_db_customizer_option('opt_small_excerpt');
    $small_excerpt_hover = fw_get_db_customizer_option('opt_small_excerpt_font_hover_color');
    $small_excerpt_medium_devices_desktops=fw_get_db_customizer_option('opt_small_excerpt_medium_devices_desktops');
	$small_excerpt_small_devices_tablets=fw_get_db_customizer_option('opt_small_small_excerpt_devices_tablets');
    $small_excerpt_extra_small_devices_phones=fw_get_db_customizer_option('opt_small_excerpt_extra_small_devices_phones');
    $small_excerpt_tiny_devices_phones=fw_get_db_customizer_option('opt_small_excerpt_tiny_devices_phones');
    ...
    $sub_menu_background_color = fw_get_db_customizer_option('opt_sub_menu_background_color');
    $mobile_menu_sub_sub_color = fw_get_db_customizer_option('opt_mobile_menu_sub_sub_color');
    $mobile_menu_sub_sub_sub_color = fw_get_db_customizer_option('opt_mobile_menu_sub_sub_sub_color');
    $mobile_menu_toggle_button_border_color = fw_get_db_customizer_option('opt_mobile_menu_toggle_button_border_color');
    $mobile_menu_toggle_button_second_level_border_color = fw_get_db_customizer_option('opt_mobile_menu_toggle_button_second_level_border_color');
    $mobile_menu_divider_color = fw_get_db_customizer_option('opt_mobile_menu_divider_color');
    $mobile_menu_sub_divider_color = fw_get_db_customizer_option('opt_mobile_menu_sub_divider_color');
    $mobile_menu_sub_sub_divider_color = fw_get_db_customizer_option('opt_mobile_menu_sub_sub_divider_color');
    $menu_background_hover_color = fw_get_db_customizer_option('opt_menu_background_hover_color');
    $menu_background_hover_color_text = fw_get_db_customizer_option('opt_menu_background_hover_color_text');
    ...
    {'
    	...
    	.'h4, .component-element h4, .component-element h4 a, .post-lead, blockquote{ font-family:'.esc_html($h4['family']).';'. thshpr_google_font_style_weight_split($h4['variation']) . 'font-size:'.esc_html($h4_tiny_devices_phones['size']).'px;'. 'color:'.esc_html($h4['color']).';'. 'letter-spacing:'.esc_html($h4['letter-spacing']).'px;'. 'line-height:'.esc_html($h4_tiny_devices_phones['line-height']).'px; }'
        ...
        .'.large-excerpt, .large-excerpt a, .sidebar .large-excerpt ,.sidebar .large-excerpt a{ font-family:'.esc_html($large_excerpt['family']).';'. thshpr_google_font_style_weight_split($large_excerpt['variation']) . 'font-size:'.esc_html($large_excerpt_tiny_devices_phones['size']).'px;'. 'color:'.esc_html($large_excerpt['color']).';'. 'letter-spacing:'.esc_html($large_excerpt['letter-spacing']).'px;'. 'line-height:'.esc_html($large_excerpt_tiny_devices_phones['line-height']).'px; }'
        ...
        .'.menu-hover-icon{color:'.esc_html($sub_menu_background_color).';}'
        .'.sidr a.hoverme:hover{ background-color:'.esc_html($menu_background_hover_color).'; color:'.esc_html($menu_background_hover_color_text).'; }'
        .'.sidr-toggle:hover{ background-color:'.esc_html($menu_background_hover_color).'; color:'.esc_html($menu_background_hover_color_text).';border-color:'.esc_html($menu_background_hover_color).'!important; }'
        .'.primary-navigation ul li ul li a{font-family:'.esc_html($sub_level_menu['family']).';'. thshpr_google_font_style_weight_split($sub_level_menu['variation']) . 'font-size:'.esc_html($sub_level_menu['size']).'px;'. 'color:'.esc_html($sub_level_menu['color']).';'. 'letter-spacing:'.esc_html($sub_level_menu['letter-spacing']).'px;'. 'line-height:'.esc_html($sub_level_menu['line-height']).'px; }'
        .'.primary-navigation ul li a{font-family:'.esc_html($top_level_menu['family']).';'. thshpr_google_font_style_weight_split($top_level_menu['variation']) . 'font-size:'.esc_html($top_level_menu['size']).'px;'. 'color:'.esc_html($top_level_menu['color']).';'. 'letter-spacing:'.esc_html($top_level_menu['letter-spacing']).'px;'. 'line-height:'.esc_html($top_level_menu['line-height']).'px; }'
        .'.primary-navigation .mega-menu-col{ border-left:1px solid '.esc_html($mega_menu_border_color).'; }'
        .'.sidr-toggle{ border:1px solid '.esc_html($mobile_menu_toggle_button_border_color).'; }'
        .'.sidr li li .sidr-toggle{ border:1px solid '.esc_html($mobile_menu_toggle_button_second_level_border_color).'; }'
        .'.sidr a { border-bottom:1px solid '.esc_html($mobile_menu_divider_color).'; }'
        .'.sidr li li a { border-bottom:1px solid '.esc_html($mobile_menu_sub_divider_color).'; }'
        .'.sidr li li li a { border-bottom:1px solid '.esc_html($mobile_menu_sub_sub_divider_color).'; }'
    ...
    {'
        ...
        .'.lead-text, h4.sub-title-header{ font-size:'.esc_html($article_lead_extra_small_devices_phones['size']).'px; line-height:'.esc_html($article_lead_extra_small_devices_phones['line-height']).'px; }'
		.'.tagcloud{ line-height:'.esc_html($categories_tags['line-height']).'px; }'
		.'.tagcloud a{ font-family:'.esc_html($categories_tags['family']).';'. thshpr_google_font_style_weight_split($categories_tags['variation']) . 'font-size:'.esc_html($categories_tags['size']).'px !important;'. 'color:'.esc_html($categories_tags['color']).';'. 'letter-spacing:'.esc_html($categories_tags['letter-spacing']).'px;'. 'line-height:'.esc_html($categories_tags['line-height']).'px; }'
    	.'.tagcloud a{ background-color:'.esc_html($categories_tags_background).';}'
    	.'.tagcloud a:hover{ background-color:'.esc_html($categories_tags_font_hover_color).';}'
    ...
    {'
        ...
        .'.lead-text, h4.sub-title-header{ font-size:'.esc_html($article_lead_small_devices_tablets['size']).'px; line-height:'.esc_html($article_lead_small_devices_tablets['line-height']).'px; }'
		.'.tagcloud{ line-height:'.esc_html($categories_tags['line-height']).'px; }'
		.'.tagcloud a{ font-family:'.esc_html($categories_tags['family']).';'. thshpr_google_font_style_weight_split($categories_tags['variation']) . 'font-size:'.esc_html($categories_tags['size']).'px !important;'. 'color:'.esc_html($categories_tags['color']).';'. 'letter-spacing:'.esc_html($categories_tags['letter-spacing']).'px;'. 'line-height:'.esc_html($categories_tags['line-height']).'px; }'
    	.'.tagcloud a{ background-color:'.esc_html($categories_tags_background).';}'
    	.'.tagcloud a:hover{ background-color:'.esc_html($categories_tags_font_hover_color).';}'
    ...
    {'
    	...
    	.'h4, .component-element h4, .component-element h4 a, .post-lead, blockquote{ font-size:'.esc_html($h4_medium_devices_desktops['size']).'px; line-height:'.esc_html($h4_medium_devices_desktops['line-height']).'px; }'
        ...
        .'.lead-text, h4.sub-title-header{ font-size:'.esc_html($article_lead_medium_devices_desktops['size']).'px; line-height:'.esc_html($article_lead_medium_devices_desktops['line-height']).'px; }'
		.'.tagcloud{ line-height:'.esc_html($categories_tags['line-height']).'px; }'
		.'.tagcloud a{ font-family:'.esc_html($categories_tags['family']).';'. thshpr_google_font_style_weight_split($categories_tags['variation']) . 'font-size:'.esc_html($categories_tags['size']).'px !important;'. 'color:'.esc_html($categories_tags['color']).';'. 'letter-spacing:'.esc_html($categories_tags['letter-spacing']).'px;'. 'line-height:'.esc_html($categories_tags['line-height']).'px; }'
    	.'.tagcloud a{ background-color:'.esc_html($categories_tags_background).';}'
    	.'.tagcloud a:hover{ background-color:'.esc_html($categories_tags_font_hover_color).';}'
    ...
    {'
    	...
    	.'h4, .component-element h4, .component-element h4 a, .post-lead,  blockquote{ font-size:'.esc_html($h4['size']).'px; line-height:'.esc_html($h4['line-height']).'px; }'
        ...
        .'.lead-text, h4.sub-title-header{ font-size:'.esc_html($article_lead['size']).'px; line-height:'.esc_html($article_lead['line-height']).'px; }'
		.'.tagcloud{ line-height:'.esc_html($categories_tags['line-height']).'px; }'
		.'.tagcloud a{ font-family:'.esc_html($categories_tags['family']).';'. thshpr_google_font_style_weight_split($categories_tags['variation']) . 'font-size:'.esc_html($categories_tags['size']).'px !important;'. 'color:'.esc_html($categories_tags['color']).';'. 'letter-spacing:'.esc_html($categories_tags['letter-spacing']).'px;'. 'line-height:'.esc_html($categories_tags['line-height']).'px; }'
    	.'.tagcloud a{ background-color:'.esc_html($categories_tags_background).';}'
    	.'.tagcloud a:hover{ background-color:'.esc_html($categories_tags_font_hover_color).';}'
